    ...
    return (
        <div className={cx('sidebar', { open: isOpen, closed: !isOpen })}>
            ...
            <div className={cx('items')}>
                <a href="/admin/dashboard" className={cx(pathName === '/admin/dashboard' && 'active')}>
                    <HomeOutlinedIcon style={{ width: '22px', height: '22px' }} />
            ...
            <div style={{ ...(!isOpen && { alignItems: 'center' }) }} className={cx('items')}>
                <span style={{ ...(!isOpen && { visibility: 'hidden' }) }}>Quản lý tài nguyên</span>
                {resourceItems.map((item, index) => (
                    <Link key={index} className={cx(pathName === item.pathAcitve && 'active')} to={item.pathAcitve}>
            ...
            <div style={{ ...(!isOpen && { alignItems: 'center' }) }} className={cx('items')}>
                <span style={{ ...(!isOpen && { visibility: 'hidden' }) }}>Thiết lập hỗ trợ</span>
            ...
            <div style={{ ...(!isOpen && { alignItems: 'center' }) }} className={cx('items')}>
                <span style={{ ...(!isOpen && { visibility: 'hidden' }) }}>Phân quyền</span>
