...
export const EditProfileAction = createAsyncThunk('EditProfileAction', async (data: UpdateProfileRequest) => {
    try {
...
export const ResetEditProfileSuccess = createAction('editDocument/resetSuccess');
...
const editProfileSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(EditProfileAction.fulfilled, (state, action: PayloadAction<UpdateProfileRequest>) => {
                state.loading = false;
                state.success = true;
