...
export const SearchUserAction = createAsyncThunk<
    SearchInterface[],
    { name: string; pageSize: number; pageNum: number }
>('SearchUserAction', async ({ name, pageSize, pageNum }) => {
    try {
...
const SearchUserSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(SearchUserAction.fulfilled, (state, action: PayloadAction<SearchInterface[]>) => {
                state.loading = false;
