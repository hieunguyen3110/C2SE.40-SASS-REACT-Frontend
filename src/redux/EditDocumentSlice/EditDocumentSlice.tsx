...
import { EditDocument, EditDocumentAPI } from '../../services/EditDocumentAPI/EditDocumentAPI';
...
export const ResetEditDocumentSuccess = createAction('editDocument/resetSuccess');
...
const EditDocumentSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(EditDocumentAction.fulfilled, (state, action: PayloadAction<EditDocument>) => {
                state.loading = false;
