...
export const UploadFileAction = createAsyncThunk<string | undefined, ApiPostFile>(
    'UploadFileAction',
    async (data: ApiPostFile) => {
        try {
...
export const SearchFolderAction = createAsyncThunk<SearchFolder[]>('SearchFolderAction', async () => {
    try {
...
const uploadFileSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(SearchFacultyAction.fulfilled, (state, action: PayloadAction<SearchFaculty[]>) => {
                state.loading = false;
                state.searchFaculty = action.payload;
            })

            .addCase(SearchFolderAction.fulfilled, (state, action: PayloadAction<SearchFolder[]>) => {
                state.loading = false;
                state.searchFolder = action.payload;
            })
            .addCase(SearchSubjectAction.fulfilled, (state, action: PayloadAction<SearchSubject[]>) => {
                state.loading = false;
...
export const { clearSearchFaculty, clearSearchFolder, clearSearchSubject } = uploadFileSlice.actions;
