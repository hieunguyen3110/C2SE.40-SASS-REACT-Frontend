...
export const ListAllNotificationAction = createAsyncThunk<NotificationResponse[], number>(
...
export const ListAllNotificationSavedAction = createAsyncThunk<NotificationResponse[], number>(
...
export const ListAllNotificationDeletedAction = createAsyncThunk<NotificationResponse[], number>(
...
export const CountNotificationAction = createAsyncThunk<any>('CountNotificationAction', async () => {
    try {
...
const NoticationSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(ListAllNotificationAction.fulfilled, (state, action: PayloadAction<NotificationResponse[]>) => {
                state.Loading = false;
            ...
            .addCase(MoveNotifyToSavedAction.fulfilled, (state, action: PayloadAction<string>) => {
                state.Loading = false;
                toast.success(action.payload);
            })
            .addCase(MoveNotifyToTrashdAction.fulfilled, (state, action: PayloadAction<string>) => {
                state.Loading = false;
                toast.success(action.payload);
            })
            .addCase(UpdateStatusNotifyAction.fulfilled, (state) => {
            ...
            .addCase(ListAllNotificationSavedAction.rejected, (state, action) => {
                state.Loading = false;
                state.Error = action.error.message || 'get all notifications is saved failed';
            })
            .addCase(ListAllNotificationDeletedAction.rejected, (state, action) => {
                state.Loading = false;
                state.Error = action.error.message || 'get all notifications is deleted failed';
            })
            ...
            .addCase(MoveNotifyToSavedAction.rejected, (state, action) => {
                state.Loading = false;
                state.Error = action.error.message || 'move notifications to saved failed';
            })
            .addCase(MoveNotifyToTrashdAction.rejected, (state, action) => {
                state.Loading = false;
                state.Error = action.error.message || 'move notifications to trash failed';
            })
            .addCase(UpdateStatusNotifyAction.rejected, (state, action) => {
                state.LoadingRead = false;
                state.Error = action.error.message || 'update status notifications failed';
            });
    },
});
