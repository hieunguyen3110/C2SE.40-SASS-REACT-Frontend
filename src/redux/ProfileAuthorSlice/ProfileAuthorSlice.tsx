...
import {
    FollowAuthorApi,
    UnFollowAuthorApi,
    ViewProfileAuthorApi,
    ViewProfileAuthorByEmailApi,
} from '../../services/ProfileAuthorApi/ProfileAuthorApi';
...
export const ViewProfileAuthorAction = createAsyncThunk('ProfileAuthorSlice/ViewProfileAuthorAction', async () => {
    try {
