            ...
            <div className={cx('footer-component-main')}>
                ...
                <div className={cx('component-main-right')}>
                    ...
                    <div className={cx('main-right-information')}>
                        <p>
                            Đào tạo, nghiên cứu gắn liền với khoa học và công nghệ nhằm tạo ra những sinh viên và học
                            viên có lòng yêu nước, có phẩm chất Nhân văn mang đậm bản sắc Việt Nam, có ý thức sinh hoạt
                            cộng đồng, có sức khỏe, tự tin, năng động, sáng tạo, có năng lực và kỹ năng toàn diện để trở
