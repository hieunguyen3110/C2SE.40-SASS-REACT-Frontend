...
export default function CreateFolder() {
    ...
    const finisher = (
        <div className={cx('finisher-container')}>
            ...
            <p>
                Thư mục của bạn đã được tạo, bạn có thể vào mục <a href="/document">Tài liệu của tôi</a> để xem và thêm
                tài liệu của bạn vào thư mục.
            </p>
            <button
                onClick={() => {
            ...
            {!isSuccess ? (
                <div className={cx('form-container')}>
                    ...
                    <div className={cx('actions')}>
                        <button onClick={handleSubmit} className={cx('next-btn')}>
                            Hoàn thành
                            <ArrowForwardIcon />
                        </button>
                    </div>
