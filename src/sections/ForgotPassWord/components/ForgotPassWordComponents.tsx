...
import { SendAuthOtpAction, updateOtpState } from '../../../redux/AuthenticationSlice/AuthenticationSlice';
    ...
    return (
        <>
            <div className={cx('main-login')}>
                ...
                <div className={cx('form-login-pass', clickForgotPass && 'forgot-animation')}>
                    <form onSubmit={formik.handleSubmit} ref={form} className={cx('form-login-main')}>
                        <h3>QUÊN MẬT KHẨU</h3>
                        ...
                        <div className={cx('main-body')}>
                            ...
                            <div className={cx('body-list')}>
                                ...
                                <input type="text" name="otp" id="otp" hidden readOnly value={otp} />
                            ...
                            <div className={cx('body-button')}>
                                <Button paddingX={20} paddingY={10} fontSize={16} text="Xác minh" />
                            </div>
                        </div>
