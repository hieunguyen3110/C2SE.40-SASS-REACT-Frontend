                ...
                <div className={cx('box-content')}>
                    ...
                    <div className={cx('content')}>
                        <p className={cx('paragraph')}>
                            We're working on the final touches to give you the best experience possible. Our website
                            will be live soon, and we can't wait for you to explore it.
                        </p>
                    </div>
                    ...
                    <div className={cx('box-content-footer')}>
                        <div className={cx('paragraph-notify')}>
                            <p>
                                ...
                                <span>to be the first to know about special updates when we launch!</span>
                            </p>
                        </div>
                        ...
                        <div className={cx('congratulation-notify')}>
                            <p>
                                Thank you for your support and patient waiting. Get ready to start a new journey with
                                us!
                            </p>
                        </div>
                    </div>
