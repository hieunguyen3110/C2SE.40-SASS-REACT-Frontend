...
const SearchUserComponents = () => {
    ...
    const debounceSearch = useCallback(
        debounce((value: string, pageSize: number, pageNum: number) => {
        ...
        <div className={cx('search-user')}>
            ...
            <div className={cx('search-user-body')}>
                {loading ? (
                    ...
                    <p className={cx('not-found')}>Không có kết quả được tìm thấy!!!</p>
                ) : (
                    listSearch.map((item, index) => (
                        <div
                            className={cx('user-body-list')}
                            key={index}
                            onClick={() => handleNavigateUser(item.email, item.firstName.concat(item.lastName))}
                        >
                            ...
                            <div className={cx('user-list-info')}>
                                ...
                                <div className={cx('user-list-department')}>
                                    <div className={cx('list-department-text')}>Khoa: Đào tạo quốc tế</div>
                                    <div className={cx('list-department-position')}>Ngành:Công nghệ phần mềm CMU</div>
                                </div>
