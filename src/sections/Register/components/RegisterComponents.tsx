...
import { KeyboardArrowDown, KeyboardArrowUp, MailOutline, Person, SensorOccupied } from '@mui/icons-material';
...
const REgisterComponents: React.FC<PopsInformation> = ({ pops }: PopsInformation) => {
    ...
    return (
        <>
            <div className={cx('main-login')}>
                ...
                <div className={cx('form-login', clickRegister && 'register-animation')}>
                    {pops.map((pop, index) => (
                        <Formik
                            key={index}
                            initialValues={{
                        ...
                        >
                            {({ isSubmitting, setFieldTouched, setFieldValue, validateField }) => (
                                <Form className={cx('form-login-main')} key={index}>
                                    ...
                                    <div className={cx('main-body')}>
                                        <div className={cx('body-list')}>
                                            <div className={cx('list-item', 'list-gmail')}>
                                                <div className={cx('list-gmail-item')}>
                                                    <MailOutline />
                                                    <Field type="text" name="email" placeholder={pop.titleGmail} />
                                                </div>
                                                <ErrorMessage
                                                    name="email"
                                                    component="div"
                                        ...
                                        <div className={cx('body-list')}>
                                            ...
                                            <div className={cx('list-row-button')}>
                                                <div className={cx('row-button-item')} onClick={handleRowItem}>
                                                    {rowRegister ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
                                                </div>
                                            </div>
                                            {rowRegister && (
                                                <div className={cx('list-row-item')}>
                                    ...
                                    <div className={cx('main-forgot')}>
                                        <div className={cx('forgot-register')}>
                                            ...
                                            <p className={cx('register-button')} onClick={handleOnClickLogin}>
                                                {pop.titleRegister}
                                            </p>
                                        </div>
                                    </div>
