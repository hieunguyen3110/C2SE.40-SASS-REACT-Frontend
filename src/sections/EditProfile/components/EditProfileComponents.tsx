...
import { clearSearchFaculty, SearchFacultyAction } from '../../../redux/UploadFileSlice/uploadFileSlice';
...
const EditProfileComponents = () => {
    ...
    const searchFaculty = useAppSelector((state) => state.uploadFile.searchFaculty) || [];
                  ...
                  <div className={cx("list-item-search")}>
                    ...
                    {majorFile.trim() && searchMajor?.length > 0 && (
                      <div className={cx("search-results")}>
                        ...
                        <button className={cx('body-individual-delete')}>Xoá tài khoản</button>
                    </div>
                </div>
            )}
        </div>
