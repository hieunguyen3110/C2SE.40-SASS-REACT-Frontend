...
const cardsData: FAQDetail[] = [
    {
        ...
        content:
            'Dịch vụ của chúng tôi là một nền tảng quản lý và lưu trữ tài liệu trực tuyến, cho phép bạn tổ chức, chia sẻ và tìm kiếm tài liệu một cách dễ dàng. Ngoài ra, chúng tôi tích hợp chatbot hỗ trợ hỏi đáp, được đào tạo từ dữ liệu tài liệu của bạn, giúp bạn tìm kiếm thông tin nhanh chóng và hiệu quả.',
    },
    {
        id: 1,
    ...
    },
    {
        ...
        content:
            'Hiện tại, kích thước tối đa cho mỗi tệp là 30MB. Nếu bạn cần tải lên tệp lớn hơn, vui lòng liên hệ chúng tôi để được hỗ trợ giải pháp phù hợp.',
    },
    {
        id: 3,
        icon: FolderAddIcon,
...
export default function Content() {
    ...
    return (
        <div className={cx('support-content')}>
            ...
            <p>Có lẽ bạn có thể tìm thấy câu trả lời trong những hỏi đáp thường gặp dưới đây của chùng tôi.</p>
