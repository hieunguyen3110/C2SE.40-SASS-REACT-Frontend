...
export default function QuestionForm() {
    ...
    return (
        <div className={cx('question-form')}>
            ...
            <p>
                Hãy viết câu hỏi của bạn vào dưới đây, chúng tôi sẽ giải đáp nhanh nhất có thể cho bạn. Câu trả lời sẽ
                được gửi về thông báo và email của bạn.
            </p>
            ...
            <span>Liên hệ với chúng tôi qua các trang mạng xã hội để được hỗ trợ sớm nhất</span>
