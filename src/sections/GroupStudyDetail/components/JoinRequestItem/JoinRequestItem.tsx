    ...
    <div className={cx('join-request-item')}>
      <div className={cx('user-info')}>
        ...
        <div className={cx('details')}>
          <Typography variant="body1" className={cx('name')}>{name}</Typography>
          <Typography variant="body2" className={cx('request-type')}>Yêu cầu</Typography>
        </div>
        <Typography variant="body2" className={cx('date')}>{requestDate}</Typography>
      </div>
