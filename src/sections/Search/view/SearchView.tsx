        ...
        <div className={cx('search-view')}>
            <div className={cx('search-container')}>
                <div className={cx('search-by')}>
                    <button onClick={() => setSearchBy('title')} className={cx(searchBy === 'title' && 'active')}>
                        Tiêu đề
                    </button>
                    <button onClick={() => setSearchBy('subject')} className={cx(searchBy === 'subject' && 'active')}>
                        Môn học
                    </button>
                    <button onClick={() => setSearchBy('folder')} className={cx(searchBy === 'folder' && 'active')}>
                        Thư mục
                    </button>
                    <button onClick={() => setSearchBy('faculty')} className={cx(searchBy === 'faculty' && 'active')}>
                        Khoa
                    </button>
                </div>
                {!isNotFound ? (
                    ...
                    <img style={{ width: '400px', height: 'auto' }} src={NotFoundIMG} alt="" />
                )}
            </div>
        </div>
    );
