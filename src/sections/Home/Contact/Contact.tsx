                ...
                <div className={cx('contact-content')}>
                    ...
                    >
                        <div>
                            ...
                            <p>
                                Đại học Duy Tân - CS Hòa Khánh Nam 120 Hoàng Minh Thảo, Hoà Khánh Nam, Liên Chiểu, Đà
                                Nẵng , Việt Nam
                            </p>
                        </div>
                        <div>
                        ...
                        <form ref={formCurrent} onSubmit={handleSubmitForm} className={cx('contact-us')}>
