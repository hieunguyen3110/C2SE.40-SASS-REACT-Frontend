...
export default function HomeView() {
    const { isFormLogin, setIsFormLogin, setFormLogin, formLogin, setIsAnimationForm } = useGlobalContextLoin();
    ...
    return (
        <main className={cx('homepage-wrapper', isFormLogin && 'home-opacity')} onClick={handleChangeFormLogin}>
            <IntroductionSection />
            <DocumentCatalog />
            <DocumentIntroduce />
            <AISection />
