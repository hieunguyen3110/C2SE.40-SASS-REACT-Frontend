...
import { fromInsideOut, slideInLeft, slideInRight } from '../../../utils/animations';
            ...
            <div>
                <div className={cx('head')}>
                    ...
                    <motion.div variants={slideInRight} initial="hidden" animate={isVisible ? 'visible' : 'hidden'}>
                        <Button text="XEM TẤT CẢ TIN TỨC" fontSize={20} paddingX={25} paddingY={11} />
                    </motion.div>
                </div>
                <motion.div
                ...
                >
                    <div className={cx('slider')}>
                        <div className={cx('card')}>
                            ...
                            <div>
                                <p>
                                    <PersonOutlineIcon sx={{ color: '#DC4342' }} />
                                    Bởi C1SE.07
                                </p>
                                <p>
                            ...
                            <p>
                                Nâng cấp, cập nhật các chức năng và tính năng mới cho trang web hỗ trợ học tập sinh viên
                                Duy Tân
                            </p>
                            <a href="#">
                        ...
                        <div className={cx('card')}>
                            ...
                            <p>Họp báo cáo kết quả triển khai hoạt động Capstone 1 của sinh viên cùng với Mentor...</p>
                            <a href="#">
                                Đọc thêm <ArrowRightAltIcon />
                            </a>
                        </div>
                        <div className={cx('card')}>
                            ...
                            <p>
                                Giảng viên ĐH Duy Tân nhận Chứng chỉ Chuyển giao Chương trình Đào tạo từ ĐH Purdue
                                Northwest
                            </p>
                            <a href="#">
                                Đọc thêm <ArrowRightAltIcon />
