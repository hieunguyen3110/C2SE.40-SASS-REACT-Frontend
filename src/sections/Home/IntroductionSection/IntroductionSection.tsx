...
export default function IntroductionSection() {
    ...
    const [currentHeadTitle, setCurrentHeadTitle] = useState<string>('TRƯỜNG ĐẠI HỌC');
    ...
    useEffect(() => {
        if (cycleIndex === 0) {
            ...
            setCurrentDescription('Mang đến cho sinh viên một môi trường học tập hiện đại và năng động');
        } else {
            setCurrentBackground(Background2);
            setCurrentAvatar(Avatar2);
            setCurrentHeadTitle('TÀI LIỆU HỌC TẬP');
            setCurrentTitle(['Tổng hợp bài giảng, tài liệu', 'Đầy đủ nhất', 'Dành cho sinh viên']);
    ...
    return (
        <div className={cx('introduction-section')}>
            <div className={cx('background')}>
                ...
                <img className={cx('background-shape')} src={ShapeBackground} alt="bg" />
                <motion.img
