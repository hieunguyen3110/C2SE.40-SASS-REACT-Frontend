        ...
        <div id="introduction" ref={sectionRef} className={cx('document-introduce-wrapper')}>
            <div>
                ...
                >
                    ...
                    <p>
                        Bạn muốn nâng cao kiến thức và kỹ năng của mình? Bạn muốn tham khảo những bài giảng, tài liệu
                        chất lượng từ những giáo viên chuyên môn của Ngàng bạn đang học? Hãy truy cập ngay vào tải liệu
                        học tập của Duy Tan Document.
                    </p>
                    <p>
                        Chúng tôi là một kho tàng tài liệu trực tuyến cung cấp một loạt các tài liệu, bải giảng đa dạng
                        và chất lượng, từ marketing, kinh doanh, CNTT, thiết kế đến kỹ năng sống và nhiều ngành, lĩnh
                        vực khác. Với lượng tài liệu phong phú từ các nguồn uy tín, chúng tôi cam kết mang đến cho bạn
                        những tài liệu chất lượng cao và mang tính thực tiễn, giúp bạn đạt hiệu quả cao trong học tập
                        hơn.
                    </p>
